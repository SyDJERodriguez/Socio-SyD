                    ...
                    <ul>
                        ...
                        <li>
                            <p class="text-justify">
                                ...
                                oficiales para venta al menudeo
                                de Productos SyD® y DAR® Refaccionarias por un monto mensual comprendido entre $501 y
                                $1,300 pesos.
                            </p>
                        </li>
                        <li>
                            <p class="text-justify">
                                ...
                                oficiales para venta al menudeo
                                de productos SyD® y DAR® Refaccionarias por un monto mensual superior a los $1,301
                                pesos.
                            </p>
                        </li>
                    </ul>
                    ...
                    <ul>
                        ...
                        <li>
                            <p class="text-justify">
                                <b>Nivel Plata</b>: Se alcanzará al comprar productos en cualquier de los canales
                                oficiales para venta al menudeo
                                de productos SyD® y DAR® Refaccionarias por un monto mensual comprendido entre $4,501 y
                                $7,000 pesos.
                            </p>
                        </li>
                        <li>
                            <p class="text-justify">
                                <b>Nivel Oro</b>: Se alcanzará al comprar productos en cualquier de los canales
                                oficiales para venta al menudeo
                                de productos SyD® y DAR® Refaccionarias por un monto mensual igual o superior a los
                                $7,001 pesos.
                            </p>
                        </li>
                    </ul>
