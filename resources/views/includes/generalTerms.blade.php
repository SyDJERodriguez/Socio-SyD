        ...
        <div class="modal-content  mb-0 pb-0">
            ...
            <div class="modal-body mb-0 pb-0">
                ...
                <p>
                    ...
                    Si usted, como Usuario, no acepta en forma absoluta estos términos y condiciones, deberá abstenerse de usar y ver la Plataforma; en caso de continuar utilizándola, se entenderá que está conforme y otorgó su consentimiento en términos del párrafo anterior.<br><br>

                    La simple utilización o acceso a la Plataforma o bien a cualquiera de las subpáginas y/o de sus ligas, le da el carácter a de Usuario e implica la aceptación, plena e incondicional, de todas y cada una de las condiciones generales y particulares incluidas en estos términos de uso en la versión publicada en el momento en que el Usuario acceda a la Plataforma, independientemente de si registra algún dato o no. En cualquier momento se podrán modificar los presentes términos de uso, siendo exclusiva responsabilidad del Usuario asegurarse de tomar conocimiento de tales modificaciones.<br><br>

                    El Usuario podrá imprimir y/o copiar cualquier información contenida o publicada en la Plataforma exclusivamente para su uso personal, no comercial. En caso de ser persona moral se estará a lo dispuesto por el artículo 148, fracción IV de la Ley Federal del Derecho de Autor. La reimpresión, publicación, distribución, asignación, sublicencia, venta, reproducción electrónica o por cualquier otro medio de cualquier información, documento o gráfico de o que aparezca en la Plataforma en todo o en parte, para cualquier uso distinto al personal, está expresamente prohibida.<br><br>

                    La información, conceptos y opiniones publicadas en la Plataforma son propiedad exclusiva de SyD.<br><br>

                    SyD no se hace responsable de las consecuencias que puedan derivar del uso y/o interpretación de los contenidos de la la página de internet, en el entendido que es bajo el criterio, responsabilidad y riesgo del Usuario el uso, aplicación y seguimiento a los consejos, comentarios, información, procedimientos, manuales de instalación, diagramas, tips, entre otros, que se den en los espacios referidos.<br><br>

                    SyD se reserva el derecho de bloquear el acceso o remover en forma parcial o total, toda información, comunicación o material que, a su exclusivo juicio, pueda resultar abusivo, difamatorio u obsceno, fraudulento, artificioso o engañoso, violatorio de derechos de autor, marcas o cualquier derecho de propiedad intelectual de un tercero, ofensivo o de cualquier forma contravenga lo establecido en estos términos y condiciones. Si el Usuario desea obtener más información sobre un tema en específico mencionado por SyD, el Usuario deberá consultarlo directamente con éste, y/o con un especialista en la materia.<br><br>

                    No está permitida ninguna acción o uso de dispositivos, robots, software u algún otro medio como [web]crawler, que interfiera o rastree indebidamente las actividades y/u operación de la Plataforma, cuentas o bases de datos de SyD. Cualquier intromisión, tentativa o actividad violatoria o contraria a las leyes de derecho de propiedad intelectual y/o a las prohibiciones estipuladas en estos términos y condiciones, harán a su causante, responsable de las acciones legales pertinentes, además de que será sujeto a las sanciones civiles y penales aplicables previstas en las leyes de la materia, además de su obligación de indemnizar a las partes afectadas por los daños que se ocasionen.<br><br>

                    De conformidad con lo dispuesto en (I) la Ley Federal de Protección de Datos Personales en Posesión de los Particulares (la “LFPD”); (II) el Reglamento de la LFPD; y (III) los Lineamientos del Aviso de Privacidad publicados en el Diario Oficial de la Federación, SyD, como Responsable del tratamiento de los datos personales que recaba, pone a disposición de sus clientes y Usuarios de plataformas digitales (cada uno referido como “Titular” o “Usuario”, indistintamente) su Aviso de Privacidad (el “Aviso”).
                ...
                <p>Cada $1 de compra de productos SyD dentro de las refaccionarias DAR o la tienda en línea de SyD, equivaldrá a $1 dentro del programa de lealtad. Esto quiere decir que, para efectos del programa de lealtad, se considerará un monto de compra para cada cliente igual al monto de compra de productos SyD que dicho cliente haya obtenido durante el mes en curso. El monto de compra de productos SyD de un cliente en alguno de los canales mencionados, se verá reflejado en el siguiente día hábil dentro del programa de lealtad.<br><br>
                    ...
                    Si un cliente cancela alguna compra durante el mes, el monto obtenido por dicha compra también será descontado de su monto mensual dentro del programa de lealtad.
                </p>
                ...
                <p>Los clientes del programa de lealtad Socio SyD, podrán acceder a diferentes beneficios al alcanzar cada uno de los niveles definidos por los montos de compra mensual en productos SyD. Habrá dos tipos de clientes registrados dentro del programa de lealtad: Clientes individuales y Clientes Corporativos.<br><br>
                    ...
                    Al alcanzar el mínimo de compra mensual requerido para llegar al primer nivel, el cliente tendrá acceso a un seguro de accidentes personales con cobertura de muerte accidental e invalidez total y permanente por accidentes. Dicho seguro se puede aplicar para el cliente individual o para los beneficiarios que designe el cliente corporativo. Más detalles sobre la cobertura de este beneficio, así como los montos asegurados de cada rubro y números de contacto en caso de ser necesario utilizar el seguro, pueden ser consultados dentro del sitio web del programa de lealtad, en la sección correspondiente al seguro de accidentes.
                ...
                <p>Algunos clientes corporativos del programa de lealtad podrán ser seleccionados para que les sea otorgado un crédito que podrán utilizar para adquirir productos SyD dentro de cualquier refaccionaria DAR o dentro del sitio web online de SyD. Los clientes para quienes aplique el ofrecimiento del crédito, así como el monto del crédito, quedan a decisión del equipo de SyD en base al comportamiento de compra que muestre cada cliente corporativo desde su ingreso al programa de lealtad.<br><br>
                    ...
                    El beneficio del seguro de accidentes personales, así como el beneficio de asistencias personales, tendrá una vigencia de 1 mes aplicable al siguiente mes de que el cliente haya alcanzado el monto de compra requerido para acceder a dichos beneficios. Por ejemplo, si el cliente alcanza el monto requerido para acceder a ambos beneficios durante el mes de enero, dichos beneficios serán activados durante todo el mes de febrero sin importar el monto de compra que el cliente haga durante ese mes.
                ...
                <p>Suspensión y Dirección invita a todos los clientes del programa a mantener permanentemente actualizados sus datos y los datos de sus beneficiarios en el caso de los clientes corporativos a través de los canales establecidos para tales fines, siguiendo las directrices que tiene definidas para el manejo y protección de la información y datos personales, de acuerdo con la normatividad vigente. Por ello, los clientes del programa podrán en cualquier momento, y de manera voluntaria, efectuar una actualización, modificación o corrección de sus datos o solicitud de eliminación de estos dentro del sitio web del programa de lealtad.<br><br>
                    ...
                    La participación en el programa por parte de los clientes de SyD es de carácter personal, por lo que la acumulación y el saldo del monto en la cuenta de cualquier cliente del programa, es un derecho personal e intransferible, y por tal motivo, no es heredable, ni podrá mezclarse con el monto obtenido de otro participante del programa de lealtad.<br><br>

                    El monto acumulado y el dinero electrónico obtenido en la cuenta del cliente y los beneficios del Programa tampoco serán transferibles (I) por liquidación del participante, (II) por desaparición del participante, o (III) por alguna otra causa.
