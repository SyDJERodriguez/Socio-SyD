...
<div class="container-fluid">
    ...
    <div class="row header ml-0">
        <div class="col-lg-3 p-2 pl-5">
            <img src="{{asset('img/logo.png')}}" width="250px" alt="">
        </div>
        <div class="col-lg-7 pl-5 pt-1">
            <form>
                <div class="form-row align-items-center">
                    <div class="col-sm-5 my-1">

                        <input type="text" class="form-control border-input" id="inlineFormInputName" placeholder="Correo">
                        <div class="col-sm-12"><a href="#" class="primary-color pr-3">¿No tienes una cuenta?</a> <a href="#" class="btn btn p-0 " style="background-color: #143153;color:white;font-size: 12px;">¡Regístrate!</a>
                        </div>
                    </div>
                    <div class="col-sm-5 my-1">
                        <input type="text" class="form-control border-input" id="inlineFormInputGroupUsername" placeholder="Contraseña">
                        <a href="#" class="primary-color">¿Olvidaste tu contraseña?</a>
                    </div>

                    <div class="col-sm-2 my-1">
                        <button type="submit" class="btn btn px-2" style="background-color: #143153;color:white;">Iniciar sesión</button>
                        <a href="#" class="disabl">Iniciar sesión</a>
                    </div>
                </div>
            </form>
        </div>
        <div class="col-lg-2" class="notification" style="padding-left: 160px;padding-top: 25px;">
    ...
    <nav class="navbar navbar-expand-lg navbar blue-dark ">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#">Tipo de cuenta</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#">compra en línea<i class="far fa-shopping-cart"></i></a>
                </li>
            </ul>
        </div>
    </nav>
