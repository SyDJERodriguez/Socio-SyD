    ...
    <div class="row header ml-0">
                ...
                <div class="form-row align-items-center">
                    <div class="col-sm-5 my-1">
                        ...
                        <div class="col-sm-12" style="display: flex; justify-content: center; align-items: flex-end;">
                            ...
                            <a href="#" class="btn btn p-0"
                                style="background-color: #143153;color:white;font-size: 12px; width: 90px;"
                                data-toggle="modal" data-target="#modalClientType">¡REGISTRATE!</a>
                        </div>
                    </div>
                    <div class="col-sm-5 my-1">
                        <input type="text" class="form-control border-input" id="inlineFormInputGroupUsername"
                            placeholder="CONTRASEÑA">
                        <div class="col-sm-12" style="display: flex; justify-content: center; align-items: flex-end;">
                            <a href="#" class="primary-color" data-toggle="modal" data-target="#modal4"><b>¿Olvidaste tu
                                    contraseña?</b></a>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-2 my-1">
                        <button type="submit" class="btn btn px-2"
                            style="background-color: #143153;color:white; width: 200px">INICIAR SESIÓN</button>
        ...
        <div class="col-lg-2 notification" style="padding-left: 160px;padding-top: 25px;">
            <div class="btn-group dropleft">
                <button type="button" class="btn dropdown-toggle" data-toggle="modal" aria-haspopup="true"
                    aria-expanded="false" data-target="#modalNotifications">
                    <span class="badge badge-danger mr-1 rounded-circle" style="font-size:10px;">1</span>
                    <i class="far fa-bell" style="color: white; font-size: 28px;"> </i>
                </button>
            </div>
        </div>
    </div>
                ...
                <div class="modal-body blue-dark">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 py2 text-center">
                            <input type="button" class="text-white btn btn bg-primary btn-sm my-2" value="si"
                                style="padding-left: 40px;padding-right: 40px;"><br>
