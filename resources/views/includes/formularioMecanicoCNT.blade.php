          ...
          <div class="alert alert-danger" id="form_alert_cnt_email" role="alert" style="border-radius: 6px;" hidden>
            ...
            <form autocomplete="off" id="cntForm" method="POST" action="{{route('cnt.register')}}">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 py-2" style="display: flex">
                        <input autocomplete="new-password" type="password" class="form-control" placeholder="CONTRASEÑA" name="password" id="password" pattern="^(?=\w*\d)(?=\w*[A-Z])(?=\w*[a-z])(?=\w*[!#$%&'()*+,\-./:;<=>?@[\\\]^_`{|}~])\S{8,16}$" title="La contraseña debe tener más de 8 caracteres, una mayúscula, un número y un caracter especial " required>
                        <p style="color: red; margin: 0;">*</p>
                    </div>
                </div>
                <div class="row ">
