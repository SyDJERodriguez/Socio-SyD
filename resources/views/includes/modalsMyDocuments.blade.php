...
<div class="modal fade" id="modal10" tabindex="-1" role="dialog" aria-labelledby="modal10" aria-hidden="true">
    <div class="modal-dialog modal-xl  " role="document">
        <div class="modal-content  mb-0 pb-0">
            ...
            <div class="modal-body mb-0 pb-0">
                <h3 class="text-uppercase font-weight-bold"> PROCESO PARA REEMBOLSO POR INVALIDEZ<br>
                    TOTAL Y PERMAMENTE POR ACCIDENTE</h3>
                <div class="line1">
                    <img src="{{asset('img/linea.png')}}" alt="">
                </div>
                <div class="container">
            ...
            <div class="modal-body mb-0 pb-0">
                ...
                <div class="container">
                    ...
                    <ul>
                        ...
                        <li>
                            Acta de defunción en original o copia certificada del asegurado afectado
                        </li>
                        <li>
...
<div class="modal fade" id="modal12" tabindex="-1" role="dialog" aria-labelledby="modal12" aria-hidden="true">
    <div class="modal-dialog modal-xl  " role="document">
        <div class="modal-content  mb-0 pb-0">
            ...
            <div class="modal-body mb-0 pb-0">
                <h3 class="text-uppercase font-weight-bold"> PROCESO PARA PAGO DE GASTOS MÉDICOS<br>
                    POR ACCIDENTE</h3>
                <div class="line1">
                    <img src="{{asset('img/linea.png')}}" alt="">
                </div>
                <div class="container">
                    ...
                    <ul>
                        <li>
                            Descarga y llena los siguientes documentos:
                        </li>
                    </ul>
...
<div class="modal fade" id="modal13" tabindex="-1" role="dialog" aria-labelledby="modal13" aria-hidden="true">
    <div class="modal-dialog modal-xl  " role="document">
        <div class="modal-content  mb-0 pb-0">
            ...
            <div class="modal-body mb-0 pb-0">
                <h3 class="text-uppercase font-weight-bold"> PROCESO PARA PAGO DE AYUDA<br>
                    POR HOSPITALIZACIÓN POR ACCIDENTE</h3>
                <div class="line1">
                    <img src="{{asset('img/linea.png')}}" alt="">
                </div>
                <div class="container">
                    ...
                    <ul>
                        <li>
                            Acude al hospital e identifícate como asegurado de <strong>CHUBB</strong>
                        </li>
                    </ul>
                    <hr class="p-0 m-0">
                    <h5 class="font-weight-bold">Paso 2</h5>
                    ...
                    <h6 class="font-weight-bold">• Documentos que tiene que llenar el hospital:</h6>
                    <ul>
                        <li>
                            Constancia de hospitalización con fechas y horas exactas de ingreso y egreso
                        </li>
