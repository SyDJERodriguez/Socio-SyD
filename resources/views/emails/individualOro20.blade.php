...
<table id="Tabla_01" width="600" height="" border="0" cellpadding="0" cellspacing="0" align="center" style="display: block">
    <tr>
        <td colspan="3">
            <img src="https://resources.quaxar.net/SyD/Socio_SyD/Socio_SyD_11_01.jpg" width="600" height="580" alt="" border="0" style="display: block"></td>
    </tr>
    <tr>
        <td colspan="3">
            <a href="https://www.sociosyd.com.mx/" target="_blank">
                <img src="https://resources.quaxar.net/SyD/Socio_SyD/Socio_SyD_11_02.jpg" width="600" height="100" alt="" border="0" style="display: block"></a></td>
    </tr>
    <tr>
        <td colspan="3">
            <img src="https://resources.quaxar.net/SyD/Socio_SyD/Socio_SyD_11_03.jpg" width="600" height="100" alt="" border="0" style="display: block"></td>
    </tr>
    <tr>
        <td>
