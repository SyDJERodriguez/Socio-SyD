...
<table id="Tabla_01" width="600" height="" border="0" cellpadding="0" cellspacing="0" align="center" style="display: block">
    <tr>
        <td colspan="3">
            <img src="https://resources.quaxar.net/SyD/Socio_SyD/Socio_SyD_27_01.jpg" width="600" height="585" alt="" border="0" style="display: block"></td>
    </tr>
    <tr>
        <td colspan="3">
            <a href="https://sociosyd.com.mx" target="_blank">
                <img src="https://resources.quaxar.net/SyD/Socio_SyD/Socio_SyD_27_02.jpg" width="600" height="85" alt="" border="0" style="display: block"></a></td>
    </tr>
    <tr>
        <td colspan="3">
            <img src="https://resources.quaxar.net/SyD/Socio_SyD/Socio_SyD_27_03.jpg" width="600" height="110" alt="" border="0" style="display: block"></td>
    </tr>
    <tr>
        <td>
