                ...
                <div class="modal-body " style="background-color: #143153;">
                    <div class="row">
                        <div class="col-lg-12 text-center">
                            <h5 class="text-white">SESIÓN EXPIRADA</h5>
                            <p class="text-white">Se ha detectado inactividad en tu sesión</p>
                            <p class="text-white">Vuelve a ingresar con tus credenciales de acceso</p>
