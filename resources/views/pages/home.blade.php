                    ...
                    <div class="our-branches__content-address-location col-md-4">
                        ...
                        <div class="our-branches__content-address-location-result">
                            ...
                            <div class="row">
                                ...
                                <div class="col-2 mapIcon"  style="padding-top: 12px">
                                ...
                                <div class="col-9">
                                    <div class="our-branches__content-address-location-result-item-body item_tel sucursal text-wrap" style="padding-left: 15px;padding-top: 5px">
                                ...
                                <div class="col-9 py-1">
                                    <div class="our-branches__content-address-location-result-item-body item_whats sucursal text-wrap" style="padding-left: 15px;padding-top: 10px">
                                        <p> 55-1016-8974</p>
                                        <br>
                                    </div>
                                </div>
