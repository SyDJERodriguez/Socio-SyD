                ...
                <form id="restoreForm" method="POST" action="{{route('update.password')}}">
                    ...
                    <div class="row ">
                        <div class="col-lg-12 py-3" style="width: 400px !important;">
                            ...
                            <label class="labelgre py-2" style="top: 85px; font-size:11px;">* Debe contener mayúsculas, minúsculas, números y caracteres especiales</label>
                            <input type="hidden" value="{{$client_number}}" name="client_number">
                        </div>
                    </div>
                    <div class="modal-footer border-top-0">
                        <input type="submit" class="btn btn" style="background-color: #00A1E3;color: white;" id="sendNewPass" value="RESTABLECER">
                    </div>
                </form>
            </div>
        </div>
