...
class InsuranceInvitationToPlataNegocio extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'schedule:invitationPlataNegocio';
     ...
     * @var string
     */
    protected $description = 'Envio de invitacion negocios a plata cada 20 de Mes';
    ...
    public function handle()
    {
        ...
        $this->info('Envio de invitacion a plata cada 20 de Mes');
    }
}
