...
class InvitationInsurance30Individual extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'schedule:seguroIndividual30';
     ...
     * @var string
     */
    protected $description = 'Envio de invitacion a seguro cada 30 de Mes. Cuenta Individual';
    ...
    public function handle(){
        ...
        try {
            ...
            if(empty($destinataries) == false){
                ...
                foreach ($destinataries as $recipient) {
                    Mail::send('emails.sinSeguroInvitacionSeguroIndividual30Mes', [] ,function($m) use ($recipient) {
        ...
        $this->info('Envio de invitacion a seguro cada 30 de Mes. Cuenta Individual');
    }
}
