...
class PlataInvitationToOroNegocio extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'schedule:invitationOroNegocio';
     ...
     * @var string
     */
    protected $description = 'Envio de invitacion negocios a oro cada 20 de Mes';
    ...
    public function handle()
    {
        ...
        try {
            ...
            if(empty($destinataries) == false){
                ...
                foreach ($destinataries as $recipient) {
                    Mail::send('emails.plataInvitacionOroDuenio15Mes', [] ,function($m) use ($recipient) {
        ...
        $this->info('Envio de invitacion negocios a oro cada 20 de Mes');
    }
}
